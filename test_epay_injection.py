...
def test_url_injection():
    ...
    print("✅ URL Injection Test Successful")
    ...
    if injected_data:
        ...
        print("✅ Decoding Test Successful")
...
def test_localstorage_injection():
    ...
    print("✅ LocalStorage Injection Test Successful")
    print(f"Final URL: {final_url}")
...
def test_sessionstorage_injection():
    ...
    print("✅ SessionStorage Injection Test Successful")
    print(f"Final URL: {final_url}")
...
def test_data_encoding():
    ...
    if len(final_url) <= 2000:
        print("✅ URL length within browser limits")
        return True
    else:
        print(f"⚠️  URL length exceeds typical browser limits ({len(final_url)} > 2000)")
